...
public class HS_Diamant {
    ...
    public void generate(SectorAPI sector) {
        ...
        diamant.getSpec().setGlowColor(new Color(254, 43, 67, 128));
        ...
        StarSystemGenerator.addOrbitingEntities(
                ...
                diamant.getRadius() * 2, // Radius to start at
                1, // Naming offset
        ...
        new HS_AddStuffs().generateStuffs(system, diamant, "HS_Corporation_Separatist");
        
        // Add jump points on habitable or working colonies
        new HS_AddStuffs().generateJumpPoints(system, diamant);
