...
public class HS_Neue_Jangala {
    ...
    public void generate(SectorAPI sector) {
        ...
        PlanetAPI venusia = system.addPlanet(
        ...
        // Mercurios market
        MarketAPI mercuriosMarket = HS_AddMarketplace.addMarketplace(
                    ...
                    0.12f); // tariff amount
                    mercuriosMarket.addIndustry(Industries.ORBITALWORKS,
                            new ArrayList<>(Arrays.asList(Items.PRISTINE_NANOFORGE)));
        ...
        neuejangala.setCustomDescriptionId("hs_planet_neuejangala");
            ...
            MarketAPI neuejangalaMarket = HS_AddMarketplace.addMarketplace(
                    "HS_Corporation_Separatist",
                    neuejangala,
                    ...
                    new ArrayList<>(
                            Arrays.asList( // which submarkets to generate
                                    ...
                                    Submarkets.SUBMARKET_STORAGE)),
                    0.12f); // tariff amount
                    neuejangalaMarket.addIndustry(Industries.ORBITALWORKS,
                            new ArrayList<>(Arrays.asList(Items.PRISTINE_NANOFORGE)));
        ...
        // Amazonia market
        MarketAPI amazoniaMarket = HS_AddMarketplace.addMarketplace(
                    "HS_Corporation_Separatist",
                    amazonia,
                    null,
                    "Neue Jangala", // name of the market
                    ...
                    new ArrayList<>(
                            Arrays.asList( // which submarkets to generate
                                    ...
                                    Submarkets.SUBMARKET_STORAGE)),
                    0.12f); // tariff amount
                    amazoniaMarket.addIndustry(Industries.ORBITALWORKS,
                            new ArrayList<>(Arrays.asList(Items.PRISTINE_NANOFORGE)));

        // Marutaina, a large gas giant with volatiles around
        PlanetAPI marutaina = system.addPlanet(
                "hs_planet_marutaina",
                star,
                "Marutaina",
                "gas_giant",
        ...
        PlanetAPI titania = system.addPlanet(
                "hs_planet_titania",
                marutaina,
                "Titania",
                "lava",
        ...
        PlanetAPI sedina = system.addPlanet(
                "hs_planet_sedinia",
                marutaina,
                "Sedinia",
                "barren",
        ...
        // Sedinia market
        MarketAPI sedinaMarket = HS_AddMarketplace.addMarketplace(
                    Factions.PIRATES,
                    sedina,
                    ...
                    new ArrayList<>(
                            Arrays.asList( // which submarkets to generate
                                    ...
                                    Submarkets.SUBMARKET_STORAGE)),
                    0.12f); // tariff amount
                    sedinaMarket.addIndustry(Industries.ORBITALWORKS,
                            new ArrayList<>(Arrays.asList(Items.PRISTINE_NANOFORGE)));
                    sedinaMarket.addIndustry(Industries.FUELPROD,
                            new ArrayList<>(Arrays.asList(Items.SYNCHROTRON)));

        // Mirar, a large planet with alot of volatiles
        PlanetAPI mirar = system.addPlanet(
                "hs_planet_mirar",
                star,
                "Mirar",
                "cryovolcanic",
        ...
        mirar.setInteractionImage("illustrations", "industrial_megafacility");
            ...
            // Mirar market
            MarketAPI mirarMarket = HS_AddMarketplace.addMarketplace(
                        "HS_Corporation_Separatist",
                        mirar,
                        null,
                        ...
                        new ArrayList<>(
                                Arrays.asList( // which submarkets to generate
                                        ...
                                        Submarkets.SUBMARKET_STORAGE)),
                        0.12f); // tariff amount
                        mirarMarket.addIndustry(Industries.FUELPROD,
                                new ArrayList<>(Arrays.asList(Items.SYNCHROTRON)));
        ...
        OrbitAPI orbit_2 = Global.getFactory().createCircularOrbit(star, 253, 8050, 112);
        ...
        MarketAPI old_station_market = Global.getFactory().createMarket("old_station_hs",
                old_station.getName(), 0);
                    ...
                    boolean hasDME = Global.getSettings().getModManager()
                            .isModEnabled("Dassault-Mikoyan Engineering");
