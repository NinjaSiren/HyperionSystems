...
import data.scripts.world.systems.checkAllSystems;
...
public class HyperionGen implements SectorGeneratorPlugin {
    ...
    public void generate(SectorAPI sector) {
        ...
        if(Global.getSettings().getBoolean("enableHyperionFaction")) {
            ...
            // Outer Worlds
            if(Global.getSettings().getBoolean("enableHyperionOuterWorlds")) {
            ...
            if(Global.getSettings().getBoolean("enableHyperionPenelope")) {
