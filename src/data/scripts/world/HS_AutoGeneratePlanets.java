...
public class HS_AutoGeneratePlanets {
    ...
    private float rand_angle() {
        Random rand = new Random();
        float minOA = 0;
        float maxOA = 360;
        return minOA + rand.nextFloat() * (maxOA - minOA);
    }
    ...
    public HS_AutoGeneratePlanets(StarSystemAPI system, PlanetAPI star, PlanetAPI[] planet, int planetAmount, 
        ...
        do {
            ...
            int planetSize = new HS_PlanetSize().planetSize(planetType, stars, starsAmount, orbit_radius, 
                    planet, counter);
            ...
            new HS_PlanetCondition(planetType, star, stars, starsAmount, orbit_radius, planet, counter, 
                    planetSize);
