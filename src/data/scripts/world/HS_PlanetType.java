...
public class HS_PlanetType {
    ...
    private float starHabitableMin(PlanetAPI star) {
        ...
        // Blue Supergiant
            ...
            return ((starRadius * 6.5f) + (starCoronaRadius / 5.5f));
        ...
        // Brown Dwarf
            ...
            return ((starRadius * 2f) + (starCoronaRadius / 1f));
